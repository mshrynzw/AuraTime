...
- [ ] 打刻API
  ...
  - `source`: `web`, `mobile`, `ic_card`, `admin`
...
- [基本設計](./100_基本設計.md): 機能一覧、画面一覧、権限モデル
- [業務フロー](./110_業務フロー.md): 勤怠から支払までのプロセス
- [API基本方針](./500_API基本方針.md): REST方針、認証、エラーハンドリング
- [API仕様_勤怠](./511_API仕様_勤怠.md): 勤怠管理APIの詳細仕様
- [API仕様_休暇](./512_API仕様_休暇.md): 休暇管理APIの詳細仕様
- [API仕様_承認](./513_API仕様_承認.md): 承認フローAPIの詳細仕様
- [API仕様_給与](./514_API仕様_給与.md): 給与管理APIの詳細仕様
- [DB設計方針](./300_DB設計方針.md): マルチテナント、ソフト削除、監査列
- [セキュリティ設計](./600_セキュリティ設計.md): 認証認可、個人情報保護
- [テスト設計](./700_テスト設計.md): テスト方針、重点テスト項目
